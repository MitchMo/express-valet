$('.menu-link').click(function() {
  ...
  switch($(this).attr('id')) {
    ...
    case 'events':
      ...
      break;
    case 'equipment':
      message = 'has all of the equipment needed for your event or location. From locking key boxes, to custom digitally created four color signage, we realize that all aspects must be presentable.';
      break;
    default:
